...
class AddMedicationScreenState extends State<AddMedicationScreen>
  ...
  bool medicationNameHeart,
      ...
      windowHeart,
      modeHeart;
  var appearance = appearanceIcons[0];
  var appearanceHeart = false;
  var intake = "none";
  var minRest = "none";
  var minRestHeart = false;
  // * i dont get this var window = "0:20";
  String windowTxt;
  ...
  void initState() {
    ...
    windowTimer = therapyForm.window;
    initialtimer = Duration();
    windowTxt = prettyDuration(windowTimer);
  }
  ...
  _updateWindow() {
    ...
    String windowSelected = prettyDuration(windowTimer, abbreviated: true);
    setState(() {
      windowTxt = windowSelected;
    });
  }
      ...
      builder: (context) {
        return AppearancePopUp(
          ...
          onPressed: () {
            Navigator.pop(context);
            setState(() {
              appearance = appearanceIcons[_selectedAppearanceIndex];
          ...
          appearancePicker: CupertinoPicker(
            ...
            children: List<Widget>.generate(
              appearanceIcons.length,
              (int index) {
                return new Center(
                  child: SvgPicture.asset(
                    appearanceIcons[index],
                    width: 30,
                    height: 30,
                  ),
                );
  ...
  Scaffold _secondScreen() {
    ...
    List<Widget> reminderRulesList =
        (widget.manager.therapyForm.reminderRules == null ||
            ...
            ? List()
            : () {
                List<ReminderRule> list = List<ReminderRule>.from(
    ...
    Widget addField = _buildAddReminderField();
    reminderRulesList.add(addField);
    return Scaffold(
