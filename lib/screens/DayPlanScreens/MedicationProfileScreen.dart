import 'package:diabetttty/components/profile_clipper.dart';
...
class _MedicationProfileState extends State<MedicationProfile> {
  ...
  //             fontSize: textSizeSmall,
  //             maxLine: 2),
  //         text("1 of 2", fontSize: textSizeSmall2),
              ...
              children: <Widget>[
                ClipPath(
                  ...
                  child: Image(
                    ...
                    fit: BoxFit.cover,
                    image: AssetImage('images/icons/clock/gradientBGblue.png'),
                  ),
                ),
                Positioned(
                  bottom: 10,
                  child: Container(
                    ...
                    child: ClipOval(
                      child: Image(
                        height: 120,
                        width: 120,
                        image: AssetImage('images/icons/clock/medication.jpeg'),
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        IconButton(
                          ...
                          padding: EdgeInsets.all(3),
                          icon: SvgPicture.asset(
                            'images/icons/clock/refresh (1).svg',
                            width: 30,
                            height: 30,
